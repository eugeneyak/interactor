...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'Lightweight interactor pattern implementation with middleware support and execution stack'
  spec.description = 'A Ruby gem providing a simple interactor pattern with middleware support and execution stack'
